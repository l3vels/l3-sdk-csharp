...
namespace L3vels.Sdk.Model
{
    ...
    /// AssetsResponse
    /// </summary>
    [DataContract(Name = "AssetsResponse")]
    public partial class AssetsResponse : IEquatable<AssetsResponse>, IValidatableObject
    {
        ...
        public AssetsResponse(List<Asset> items = default(List<Asset>), decimal total = default(decimal), decimal limit = default(decimal), decimal page = default(decimal))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for AssetsResponse and cannot be null");
            }
            this.Items = items;
            this.Total = total;
            this.Limit = limit;
