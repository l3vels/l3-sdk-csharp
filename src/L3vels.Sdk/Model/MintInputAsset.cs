...
namespace L3vels.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MintInput_asset")]
    public partial class MintInputAsset : IEquatable<MintInputAsset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MintInputAsset" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MintInputAsset() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MintInputAsset" /> class.
        /// </summary>
        ...
        public MintInputAsset(decimal tokenId = default(decimal), string assetId = default(string), decimal amount = default(decimal))
        {
            this.Amount = amount;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MintInputAsset {\n");
        ...
        {
            return this.Equals(input as MintInputAsset);
        }

        /// <summary>
        /// Returns true if MintInputAsset instances are equal
        /// </summary>
        /// <param name="input">Instance of MintInputAsset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MintInputAsset input)
        {
            if (input == null)
            {
                return false;
