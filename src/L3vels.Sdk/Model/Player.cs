...
namespace L3vels.Sdk.Model
{
    ...
    public partial class Player : IEquatable<Player>, IValidatableObject
    {
        ...
        /// <param name="gameId">The unique identifier of the game that the Player is associated with. This allows developers to organize their players by game and helps with tracking and reporting. Example: Player Jack is associated with game Fortnite. (required).</param>
        ...
        public Player(string id = default(string), string uniqueId = default(string), string name = default(string), string username = default(string), string email = default(string), string avatar = default(string), Object customProps = default(Object), DateTimeOffset lastSeen = default(DateTimeOffset), string accountId = default(string), string gameId = default(string), DateTimeOffset createdOn = default(DateTimeOffset), DateTimeOffset modifiedOn = default(DateTimeOffset), string createdBy = default(string), string modifiedBy = default(string), bool isCreateWallet = default(bool))
        {
            ...
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for Player and cannot be null");
            }
            this.AccountId = accountId;
            // to ensure "gameId" is required (not null)
            if (gameId == null)
            {
                throw new ArgumentNullException("gameId is a required property for Player and cannot be null");
            }
            this.GameId = gameId;
            ...
            if (createdBy == null)
            {
                throw new ArgumentNullException("createdBy is a required property for Player and cannot be null");
            }
            this.CreatedBy = createdBy;
            // to ensure "modifiedBy" is required (not null)
            if (modifiedBy == null)
            {
                throw new ArgumentNullException("modifiedBy is a required property for Player and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The unique identifier of the game that the Player is associated with. This allows developers to organize their players by game and helps with tracking and reporting. Example: Player Jack is associated with game Fortnite.</value>
