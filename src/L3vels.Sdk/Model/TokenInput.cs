...
namespace L3vels.Sdk.Model
{
    ...
    /// TokenInput
    /// </summary>
    [DataContract(Name = "TokenInput")]
    public partial class TokenInput : IEquatable<TokenInput>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenInput" /> class.
        /// </summary>
        ...
        public TokenInput(decimal tokenId = default(decimal), string assetId = default(string), decimal amount = default(decimal))
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as TokenInput);
        }

        /// <summary>
        /// Returns true if TokenInput instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenInput input)
        {
            if (input == null)
            {
                return false;
